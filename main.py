...
class MediaDial(MediaAction):
    ...
    def update_image(self):
        ...
        # Clear native global labels so the action renders text dynamically from its own settings
        ...
        # 2. Artist Name & Song Title (6px left margin, exact 5px vertical gap, action-specific font settings)
        left_margin = 6
        artist_y = 4
